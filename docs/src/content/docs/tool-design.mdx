...
**Practical rule:** at 5-15 tools you're probably fine front-loading. Past that, lazy load via Tool Search Tool, progressive disclosure, or [Skills](/skills/).
...
- [Context Engineering](/context-engineering/) — tool-layer compression is the "select" + "compress" strategy at the action layer
- [Skills](/skills/) — when a tool's setup is too complex for a single function, package it as a skill
- [Harness Engineering](/harness-engineering/) — tools are part of the harness; this page is the tool-design slice
- [Research Notes](/research-notes/) — primary sources for every number on this page
