...
How you measure whether an agent actually works. Distinct from [Benchmarks](/benchmarks/) — benchmarks are the public leaderboards (SWE-bench, GAIA, Terminal-Bench); evals are *your* tests against *your* failure modes.
...
- [Benchmarks](/benchmarks/) — the public leaderboards this page is *not* about
- [Harness Engineering](/harness-engineering/) — the system you're evaluating
- [Context Engineering](/context-engineering/) — one of the things your evals measure
- [Research Notes](/research-notes/) — primary sources for every claim and number on this page
