...
Curated entry points to follow the field. Organized by depth of commitment — start at the top, add lower-frequency sources as you have bandwidth. Everything here is referenced from primary sources in the [Research Notes](/research-notes/) bibliography.
...
- [Who's Who](/who-is-who/) — the people behind many of these sources, with profiles
- [Schools](/schools/) — the broader intellectual lineages this reading list draws from
- [Research Notes](/research-notes/) — primary-source bibliography with key claims pulled per URL
