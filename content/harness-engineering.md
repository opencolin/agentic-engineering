...
| First-party agent SDKs (loop + tools + hooks pre-built) | [Claude Agent SDK](approaches.md#claude-agent-sdk) (Anthropic, MIT Python + 7K stars / 1.5K TS — the same harness inside Claude Code), [OpenAI Agents SDK](approaches.md#openai-agents-sdk) (27K), [Google ADK](approaches.md#google-adk-agent-development-kit) (20K), [Strands Agents](approaches.md#strands-agents) (AWS, 5.9K) | [Approaches: Frameworks & SDKs](approaches.md#index) |
| Open packaged harness on LangGraph | [Deep Agents (LangChain)](approaches.md#deep-agents-langchain) — model-neutral, batteries-included; planning + virtual FS + sub-agents + summarization as composable middleware; v0.5 alpha April 2026 | [Approaches: Deep Agents](approaches.md#deep-agents-langchain) |
| End-to-end reference harness (skill pack) | [GStack](approaches.md#gstack) — Garry Tan's 23-skill Claude Code setup, MIT, 102K stars; one-command install, paired with Conductor for parallel worktrees | [Approaches: GStack](approaches.md#gstack) |
| End-to-end reference harness (memory + ops side) | [GBrain](approaches.md#gbrain) — Garry Tan's persistent-memory companion: typed knowledge graph + 29 skills + Postgres-native "Minions" job queue; MIT, 19K stars; *"GStack is the engine, GBrain is the mod"* | [Approaches: GBrain](approaches.md#gbrain) |
